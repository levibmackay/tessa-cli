...
Lydia > add input validation to the login handler and run the tests
```
...
- **An actual agent loop**, not just chat: Lydia can read files, search your
...
```
Lydia > fix the bug where login accepts an empty password
